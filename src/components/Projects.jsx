...
const Projects = () => {
  return (
    <section id="projects" className="max-w-screen-xl mx-auto px-4 py-12">
      ...
      {/* Project 1 */}
      <div className="mb-16">
        <h3 className="text-2xl text-white font-semibold mb-4">Meeting Attendance and Management Website</h3>
        ...
        <button className="mt-4 px-6 py-2 bg-transparent border-2 border-yellow-500 text-yellow-500 rounded-full hover:bg-yellow-500 hover:text-white transition duration-300 ease-in-out">
          See More
        </button>
      </div>
      ...
      {/* Msafiri App Project */}
      <div className="mb-16">
        <h3 className="text-2xl font-semibold mb-4">Msafiri App Project</h3>
      ...
      <div className="text-center">
        <button className="px-8 py-3 bg-green-500 text-white rounded-full hover:bg-green-600 transition duration-300 ease-in-out">
          More Project Works
        </button>
      </div>
    </section>
